...
class AppThemeWidget extends StatefulWidget {
  ...
  static String routeName = 'AppTheme';
  static String routePath = '/appTheme';
          ...
          child: Column(
            ...
            children: [
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: FFAppState().darkMode == 'System'
                                ...
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Visibility(
                                  visible: FFAppState().darkMode == 'System',
                                  child: Container(
                                    width: 12.0,
                                    height: 12.0,
                                    decoration: BoxDecoration(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle,
                                  border: Border.all(
                                    color: FFAppState().darkMode == 'Light'
                                        ? FlutterFlowTheme.of(context).primary
                                        : FlutterFlowTheme.of(context)
                                            .iconColor,
                                    width: 2.0,
                                ...
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Visibility(
                                  visible: FFAppState().darkMode == 'Light',
                                  child: Container(
                                    width: 12.0,
                                    height: 12.0,
                                    decoration: BoxDecoration(
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: BoxShape.circle,
                                  border: Border.all(
                                    color: FFAppState().darkMode == 'Dark'
                                        ? FlutterFlowTheme.of(context).primary
                                        : FlutterFlowTheme.of(context)
                                            .iconColor,
                                    width: 2.0,
                                ...
                                alignment: AlignmentDirectional(0.0, 0.0),
                                child: Visibility(
                                  visible: FFAppState().darkMode == 'Dark',
                                  child: Container(
                                    width: 12.0,
                                    height: 12.0,
                                    decoration: BoxDecoration(
              ...
              Padding(
                ...
                child: Text(
                  'Choose your preferred appearance mode for the app.',
