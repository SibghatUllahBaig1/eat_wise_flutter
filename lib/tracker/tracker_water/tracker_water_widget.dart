...
import 'tracker_water_model.dart';
export 'tracker_water_model.dart';

class TrackerWaterWidget extends StatefulWidget {
  const TrackerWaterWidget({super.key});

  static String routeName = 'TrackerWater';
  static String routePath = '/trackerWater';

  @override
  State<TrackerWaterWidget> createState() => _TrackerWaterWidgetState();
}

class _TrackerWaterWidgetState extends State<TrackerWaterWidget> {
  late TrackerWaterModel _model;
                                    ...
                                    child: Container(
                                      ...
                                      child:
                                        ...
                                        borderColor:
                                            FlutterFlowTheme.of(context)
                                                .primaryBackground,
                                        waterColor: FlutterFlowTheme.of(context)
                                            .waterColor,
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 0.0,
                                                                16.0, 0.0),
                                                    child: Text(
                                                      'Daily goal: ${FFAppState().trackerSettings.water.goal.toString()} mL ',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyLarge
