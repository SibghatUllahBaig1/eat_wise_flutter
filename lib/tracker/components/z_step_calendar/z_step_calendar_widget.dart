...
import 'z_step_calendar_model.dart';
export 'z_step_calendar_model.dart';

class ZStepCalendarWidget extends StatefulWidget {
  const ZStepCalendarWidget({super.key});

  @override
  State<ZStepCalendarWidget> createState() => _ZStepCalendarWidgetState();
}

class _ZStepCalendarWidgetState extends State<ZStepCalendarWidget>
    with TickerProviderStateMixin {
  late ZStepCalendarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZStepCalendarModel());
                                ...
                                onPressed: () async {
                                  _model.selectedMonthAndYear =
                                      functions.getLastMonthDateTime(
                                          _model.selectedMonthAndYear!);
                                  // Load step progress for the new month
                                  final monthDays = functions
                                      ...
                                      .toList();
                                  await _model
                                      .loadStepProgressForDates(monthDays);
                                  safeSetState(() {});
                                },
                              ),
                              Text(
