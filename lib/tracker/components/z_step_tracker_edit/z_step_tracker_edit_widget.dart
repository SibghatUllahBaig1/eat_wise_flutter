...
import 'z_step_tracker_edit_model.dart';
export 'z_step_tracker_edit_model.dart';

class ZStepTrackerEditWidget extends StatefulWidget {
  const ZStepTrackerEditWidget({super.key});

  @override
  State<ZStepTrackerEditWidget> createState() => _ZStepTrackerEditWidgetState();
}
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: daysItem ==
                                  ...
                                  ? FlutterFlowTheme.of(context).stepAccent
