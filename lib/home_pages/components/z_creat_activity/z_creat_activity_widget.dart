...
class ZCreatActivityWidget extends StatefulWidget {
  ...
  @override
  State<ZCreatActivityWidget> createState() => _ZCreatActivityWidgetState();
}

class _ZCreatActivityWidgetState extends State<ZCreatActivityWidget> {
  late ZCreatActivityModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(6.0, 50.0, 6.0, 16.0),
            child: Row(
              mainAxisSize: MainAxisSize.max,
              children: [
