...
import 'z_food_card_model.dart';
export 'z_food_card_model.dart';

class ZFoodCardWidget extends StatefulWidget {
  const ZFoodCardWidget({
    super.key,
  ...
  @override
  State<ZFoodCardWidget> createState() => _ZFoodCardWidgetState();
}

class _ZFoodCardWidgetState extends State<ZFoodCardWidget> {
  late ZFoodCardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZFoodCardModel());
  }
