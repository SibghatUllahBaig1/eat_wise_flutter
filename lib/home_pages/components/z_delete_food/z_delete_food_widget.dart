...
import 'z_delete_food_model.dart';
...
class _ZDeleteFoodWidgetState extends State<ZDeleteFoodWidget> {
  late ZDeleteFoodModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZDeleteFoodModel());
  }
