...
import 'z_activity_log_model.dart';
export 'z_activity_log_model.dart';

class ZActivityLogWidget extends StatefulWidget {
  const ZActivityLogWidget({super.key});

  @override
  State<ZActivityLogWidget> createState() => _ZActivityLogWidgetState();
}

class _ZActivityLogWidgetState extends State<ZActivityLogWidget> {
  late ZActivityLogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZActivityLogModel());
                ...
                if (_model.textController.text != null &&
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        wrapWithModel(
                          model: _model.zActivityLogContentModel1,
                          updateCallback: () => safeSetState(() {}),
                          child: ZActivityLogContentWidget(),
                        ),
                      ]
                  ...
                  return Container(
                    ...
                    child: PageView(
                      ...
                      children: [
                        wrapWithModel(
                          model: _model.zActivityLogContentModel2,
                          updateCallback: () => safeSetState(() {}),
                          child: ZActivityLogContentWidget(),
                        ),
                        wrapWithModel(
                          model: _model.zActivityLogContentModel3,
                          updateCallback: () => safeSetState(() {}),
                          child: ZActivityLogContentWidget(),
                        ),
                        wrapWithModel(
                          model: _model.zActivityLogContentModel4,
                          updateCallback: () => safeSetState(() {}),
                          child: ZActivityLogContentWidget(),
                        ),
                      ],
