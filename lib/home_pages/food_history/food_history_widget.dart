...
import 'food_history_model.dart';
export 'food_history_model.dart';

class FoodHistoryWidget extends StatefulWidget {
  const FoodHistoryWidget({super.key});

  static String routeName = 'FoodHistory';
  static String routePath = '/foodHistory';
...
class _FoodHistoryWidgetState extends State<FoodHistoryWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FoodHistoryModel());
  }
