...
/// Utility to upload hardcoded recipes from app_state.dart to Firebase Firestore
///
/// Call this function from the admin panel to populate the recipes collection
/// with the hardcoded recipe data.

Future<Map<String, dynamic>> uploadHardcodedRecipes() async {
  final firestore = FirebaseFirestore.instance;
  final recipesCollection = firestore.collection('recipes');

  // Hardcoded recipes data from app_state.dart (lines 634-655)
  // Updated to use proper diet category names from admin panel
  final recipes = [
    {
