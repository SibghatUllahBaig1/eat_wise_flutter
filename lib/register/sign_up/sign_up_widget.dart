                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    if (_model.termPolicy) {
                      _model.termPolicy = false;
                      safeSetState(() {});
                    } else {
                      _model.termPolicy = true;
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: () {
                              ...
                              } else if (_model.termPolicy) {
                                return FlutterFlowTheme.of(context).transparent;
                              } else {
                                return FlutterFlowTheme.of(context).iconColor;
                              }
                            }(),
                            width: 1.5,
                          ),
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          // New users continue with onboarding; existing users go to the app.
