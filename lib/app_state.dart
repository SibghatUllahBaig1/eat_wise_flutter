...
class FFAppState extends ChangeNotifier {
  ...
  TrackerStruct _tracker = TrackerStruct.fromSerializableMap(jsonDecode(
      '{\"step\":\"[]\",\"water\":\"[]\",\"weight\":\"[]\",\"current_date\":\"${DateTime.now().millisecondsSinceEpoch}\",\"selected_date\":\"${DateTime.now().millisecondsSinceEpoch}\"}'));
